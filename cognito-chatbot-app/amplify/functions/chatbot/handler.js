...
export const handler = async (event) => {
  console.log('Chatbot Lambda invoked', JSON.stringify(event, null, 2));
  ...
  try {
    ...
    const userRole = validateRole(claims);
    ...
    const documents = await retrieveKnowledgeBase();
